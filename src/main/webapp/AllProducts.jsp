					...
					<div class="card h-90 shadow-sm">
						...
						<div class="card-body">
							<div class="clearfix mb-3">
								<span class="float-start badge rounded-pill bg-primary">${it.productname }</span> 
								<span class="float-end price-hp">Rs. ${it.price }</span>
							</div>
							<h5 class="card-title">Deal Of day</h5>
