					...
					<div class="card" style="border-radius: 10px;">
						<div class="card-header px-4 py-5">
							<h5 class="text-muted mb-0">
								...
								<!-- <span style="color: #a8729a;">${it.username}</span>!</h5> -->
						</div>
						<div class="card-body p-4">
							...
							%>
							<c:forEach items="${orderdetails}" var="it">
									...
									<div class="card-body">
										<div class="row">
											...
											<div
												...
												<p class="text-muted mb-0">${it.productname }</p>
											</div>
											<div
												class="col-md-2 text-center d-flex justify-content-center align-items-center">
											...
											<div
												class="col-md-2 text-center d-flex justify-content-center align-items-center">
												<p class="text-muted mb-0 small">Rs. ${it.price }</p>
											</div>
										</div>
										<hr class="mb-4"
						...
						<div class="card-footer border-0 px-4 py-5"
							...
							<a href="MyOrdersController">View All Orders</a> <span
								style="color: #a8729a;">${it.orderid.userid.firstname}</span>!
							</h5>
							<h5
								class="d-flex align-items-center justify-content-end text-white text-uppercase mb-0">
								Total paid: <span class="h2 mb-0 ms-2">Rs.${it.price}</span>
							</h5>
						</div>
					</div>
				</div>
